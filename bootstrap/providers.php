...
return [
    ...
    App\Providers\CompanyRepresentativeServiceProvider::class,
    App\Providers\CompanyServiceProvider::class,
    App\Providers\ContractDisputeServiceProvider::class,
    App\Providers\ContractVariationServiceProvider::class,
    ...
    App\Providers\InventoryReceiptItemServiceProvider::class,
    App\Providers\InventoryReceiptServiceProvider::class,
    App\Providers\InventoryReceiptServiceProvider::class,
    App\Providers\InventoryReservationServiceProvider::class,
    App\Providers\InventoryReturnServiceProvider::class,
    App\Providers\InventoryTransactionServiceProvider::class,
    App\Providers\InventoryTransferItemServiceProvider::class,
    App\Providers\InventoryTransferServiceProvider::class,
    App\Providers\InventoryValuationServiceProvider::class,
    ...
    App\Providers\LegalAuditTrailServiceProvider::class,
    App\Providers\LegalClearanceServiceProvider::class,
    App\Providers\LegalComplianceCheckServiceProvider::class,
    App\Providers\LegalDocumentServiceProvider::class,
    App\Providers\LegalReviewServiceProvider::class,
