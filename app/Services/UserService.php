...
class UserService extends BaseService
{
    ...
    public function store(array $data)
    {
        return DB::transaction(function () use ($data) {
            ...
            $user = parent::store([
                ...$data,
                'grade_level_id' => isset($data['grade_level_id']) && (int) $data['grade_level_id'] > 0 ? (int) $data['grade_level_id'] : null,
                'department_id' => isset($data['department_id']) && (int) $data['department_id'] > 0 ? (int) $data['department_id'] : null,
                'role_id' => isset($data['role_id']) && (int) $data['role_id'] > 0 ? (int) $data['role_id'] : null,
    ...
    public function update(int $id, array $data, $parsed = true)
    {
        return DB::transaction(function () use ($id, $parsed, $data) {
            ...
            $user = parent::update($id, [
                ...
                'role_id' => isset($data['role_id']) && (int) $data['role_id'] > 0 ? (int) $data['role_id'] : null,
                'email' => $data['email'],
                'location_id' => isset($data['location_id']) && (int) $data['location_id'] > 0 ? (int) $data['location_id'] : null,
